...
-- Üretim Zamanı: 20 Şub 2023, 12:52:25
...
CREATE TABLE `orders` (
  ...
  `pizza_quantity` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `body` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'sırada',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
(5, 2, '2023-02-21', '21:06', 6, 16, 17, '3', 'osman', 'sırada', '2023-02-19 13:06:31', '2023-02-19 13:06:31', '1234567890'),
...
(1, 1, 'YEŞİL LEZZETLER', 'yesil-lezzetler', '2023-02-14 11:05:56', '2023-02-14 11:05:56'),
...
(1, 'Admin', 'admin@gmail.com', NULL, '$2y$10$7XtmMnqMbp6gOB6etngECu179tkqsBMSnaLNwhhn62rsD4ZxT83sq', 1, NULL, '2023-02-14 06:37:54', '2023-02-14 06:37:54'),
